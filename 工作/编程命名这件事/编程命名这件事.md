...
思考历程：2、3、4难道是因为首页历史包袱太沉重，推荐迭代的版本实在太多导致Old、New单词不够用所以用数字来代替新旧4个历史阶段的版本吗？事实上这些包属于母包下不同的业务场景。
...
1. TextUtils.equals(isFestivalOn, "1") 这个方法由于有 isXxxOn 的原因，推断，这个 "1" 有可能是用于开关。
